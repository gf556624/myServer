...
WPMAINCORE_API int Roseek_ISP_SetEnhancementPreSetParams(UINT32 CMin, UINT32 CMax);
WPMAINCORE_API int Roseek_ISP_GetEnhancementPreSetParams(UINT32 *pCMin, UINT32 *pCMax);
...
WPMAINCORE_API int Roseek_ISP_SetLUT(UINT32 id, UINT32 Mode, float Gamma, UINT8 *pTable, UINT32 TableSize);
WPMAINCORE_API int Roseek_ISP_GetLUT(UINT32 id, UINT32 *pMode, float *pGamma, UINT8 *pTable, UINT32 TableSize);
